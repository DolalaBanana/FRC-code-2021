...
public class DriveTrain extends SubsystemBase {
  ...
  WPI_TalonFX RightDrive1 = new WPI_TalonFX(05);
  WPI_TalonFX RightDrive2 = new WPI_TalonFX(04);
...
public void AutonomousDRT (){
  timer.reset();
  timer.start();

  if(timer.get() < 2){
    m_safety_drive.arcadeDrive(-0.3, 0.0);

  }
  m_safety_drive.arcadeDrive(0, 0.0);
}
}
